...
This behavior in gazelles is called [stotting](https://en.wikipedia.org/wiki/Stotting), and it is an example of signaling in the animal world. But not just any signaling, *honest* signaling. Jump height cannot be faked, and the cheetah knows exactly what it means.

![A gazelle mid-stott, leaping high to signal fitness to a predator](/stotting.jpg)
...
<div style="position:relative;padding-bottom:56.25%;height:0;overflow:hidden;margin:2rem 0;">
  <iframe
    src="https://www.youtube.com/embed/tqXOcRtZoow"
...
Different audiences respond to different signal types in different ways. To some, the mere (perceived) cost of a campaign will be enough to be impressive. To others, if the cost seems disproportionate to the product category, it's interpreted as desperation. "Why do they need to try so hard? Something's off." [(Research Study)](https://www.sciencedirect.com/science/article/abs/pii/S0167487012000979)
...
![The Sistine Chapel ceiling, Michelangelo's masterpiece, painted at extraordinary personal cost](/sistine.jpg)

Now, AI can [produce art](https://docs.google.com/forms/d/e/1FAIpQLSdqpfY0OXLQoO_UNkhKTAtQbmh8EX_xpAAaGV6mxlBDms9CzQ/viewform) that is as intricate and aesthetic as most fine art. But no one will fly across the world for the chance to see it. The value lies in its beauty and the cost that one of the most talented artists of all time paid to create it.
...
"Slop" was the Merriam-Webster word of 2025. Consumer enthusiasm for AI-generated creator work has [dropped](https://www.emarketer.com/content/consumer-skepticism-of-ai-creator-economy-surging) from 60% to 26% since 2023, and 3x as many Americans [reject](https://www.edelman.com/trust/2025/trust-barometer/flash-poll-trust-artifical-intelligence) growing AI use (49%) as embrace it (17%).
...
People evaluate your signals defensively when they feel like they're being sold to. There's an interesting paradox when it comes to persuasion: people are only willing to be persuaded if they think the presenter is *not* trying to persuade them. [[Study](https://www.bps.org.uk/research-digest/more-persuasive-arguments-arent-always-more-convincing)]
...
<div style="display:flex;gap:1.5rem;margin:2rem 0;">
  <img src="/jacket.jpg" alt="A jacket with visible wear, an example of honest, unpolished signaling" style="width:50%;object-fit:cover;border-radius:4px;margin:0;" />
  <img src="/vw%20think%20small.jpeg" alt="Volkswagen's iconic Think Small ad, a masterclass in defensive, counter-intuitive signaling" style="width:50%;object-fit:cover;border-radius:4px;margin:0;" />
</div>
...
![Workwear as counter-signal, tech leaders in casual clothes redefining what power looks like](/workwear.jpg)
